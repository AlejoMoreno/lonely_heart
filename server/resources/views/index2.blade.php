...
<html lang="en" class="no-js">
  <head>
    ...
    <meta name="description" content="lonely heart">
    <meta name="robots" content="noindex, follow" />
    <meta name="viewport" content="width=device-width, minimum-scale=1, maximum-scale=1" />

    <link rel="stylesheet" media="all" href="/assets/css/index.css" />
    <link rel="stylesheet" media="all" href="/assets/css/index_2.css" />
		...
		<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="index.html" title=""><img src="/assets/icon/logo.png" alt=""></a>
					</div><!--logo end-->
						...
						<ul>
							...
							<li>
								<a href="profiles.html" title="">
									<span><img src="/assets/icon/icon4.png" alt=""></span>
									Profiles
								</a>
								<ul>
								...
								<div class="notification-box msg">
									...
									<div class="nott-list">
										<div class="notfication-details">
						  				...
						  				<div class="notfication-details">
							  				<div class="noty-user-img">
							  					<img src="/assets/icon/ny-img2.png" alt="">
							  				</div>
							  				<div class="notification-info">
							  					<h3><a href="messages.html" title="">Jassica William</a></h3>
						  				...
						  				<div class="notfication-details">
							  				<div class="noty-user-img">
							  					<img src="/assets/icon/ny-img3.png" alt="">
							  				</div>
							  				<div class="notification-info">
							  					<h3><a href="messages.html" title="">Jassica William</a></h3>
								...
								<div class="main-left-sidebar no-margin">
									...
									<div class="suggestions full-width">
										...
										<div class="suggestions-list">
											...
											<div class="suggestion-usd">
												<img src="/assets/icon/s5.png" alt="">
												<div class="sgt-text">
													<h4>Jessica William</h4>
													<span>Graphic Designer</span>
												</div>
											...
											<div class="suggestion-usd">
												<img src="/assets/icon/s6.png" alt="">
												<div class="sgt-text">
													<h4>John Doe</h4>
													<span>PHP Developer</span>
												</div>
									...
									<div class="posts-section">
										<div class="post-bar">
											<div class="post_topbar">
												<div class="usy-dt">
													<img src="/assets/icon/us-pic.png" alt="">
													<div class="usy-name">
														<h3>John Doe</h3>
														<span><img src="/assets/icon/clock.png" alt="">3 min ago</span>
													</div>
												</div>
												<div class="ed-opts">
											...
											<div class="epi-sec">
												<ul class="descp">
													<li><img src="/assets/icon/icon8.png" alt=""><span>Epic Coder</span></li>
													<li><img src="/assets/icon/icon9.png" alt=""><span>India</span></li>
												</ul>
												<ul class="bk-links">
											...
											<div class="job-status-bar">
												<ul class="like-com">
													<li>
														...
														<img src="/assets/icon/liked-img.png" alt="">
														<span>25</span>
													</li> 
													<li><a href="#" title="" class="com"><img src="/assets/icon/com.png" alt=""> Comment 15</a></li>
												</ul>
											...
											<div class="profiles-slider">
												<div class="user-profy">
													...
													<ul>
														...
														<li><a href="#" title="" class="envlp"><img src="/assets/icon/envelop.png" alt=""></a></li>
														<li><a href="#" title="" class="hire">hire</a></li>
													</ul>
													<a href="#" title="">View Profile</a>
												</div><!--user-profy end-->
												<div class="user-profy">
													<img src="/assets/icon/user2.png" alt="">
													<h3>John Doe</h3>
													<span>Graphic Designer</span>
													<ul>
														<li><a href="#" title="" class="followw">Follow</a></li>
												...
												<div class="user-profy">
													<img src="/assets/icon/user3.png" alt="">
													<h3>John Doe</h3>
													<span>Graphic Designer</span>
													<ul>
														<li><a href="#" title="" class="followw">Follow</a></li>
